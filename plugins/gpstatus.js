...
cmd({
    ...
    try {
        ...
        if (
            ...
            return reply(
                '❌ Unsupported media! Please reply to an image, video, or audio file.'
            );
        }
        ...
        await reply(
            '🔍 Checking groups where the bot is an admin...'
        );
        ...
        for (const groupId of groupIds) {
            try {
                ...
                // Only check the bot's admin status
